...
Tu cuenta, mientras esté activa. Los registros de compras y los datos fiscales,
durante el plazo que exige la legislación fiscal mexicana (cinco años). Al
eliminar tu cuenta borramos tus datos, salvo los que debamos conservar por
obligación legal, que quedan bloqueados y no se usan para ninguna otra
finalidad.

## Tus derechos ARCO

Puedes acceder a tus datos, rectificarlos cuando sean inexactos, cancelarlos
cuando consideres que no se requieren y oponerte a su tratamiento para fines
específicos.

Para ejercerlos, envía una solicitud al correo de contacto indicando tu nombre,
un medio para responderte, documentos que acrediten tu identidad y una
descripción clara de los datos y el derecho que quieres ejercer. Respondemos en
un plazo máximo de veinte días hábiles.

Puedes revocar tu consentimiento en cualquier momento por la misma vía.

## Eliminación de datos

El procedimiento está en **[Eliminación de datos](./data-deletion.md)**.

## Cookies y almacenamiento local

Usamos almacenamiento local del navegador y del dispositivo para mantener tu
sesión iniciada y recordar preferencias de la interfaz. No usamos cookies de
...
Aplicamos cifrado en tránsito (HTTPS), almacenamiento de contraseñas con
funciones de derivación, cifrado de los tokens de proveedores de pago y control
de acceso por roles. Ningún sistema es infalible: si ocurre una vulneración que
afecte significativamente tus derechos, te lo notificaremos.

## Cambios

Publicaremos la versión vigente en esta misma dirección con su fecha. Si el
cambio es sustancial, te avisaremos por correo electrónico.
